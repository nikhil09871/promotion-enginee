...
// const VALID_COUNTRIES = ['US', 'IN', 'CA']; // You can move this to a config file if needed
...
//   // ✅ Get and sort rules by ascending priority (lower = more important)
//   const rules = getRules().sort((a, b) => a.priority - b.priority);

//   for (const rule of rules) {
//     if (matchRule(rule.conditions, player)) {
//       hits.inc();
//       recordLatency(start);
//       return res.json(rule.promotion);
//     }
//   }
...
//   if (!VALID_COUNTRIES.includes(player.country)) {
//     return `Unsupported country: ${player.country}`;
//   }
